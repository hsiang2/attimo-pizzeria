                ...
                <div className="container">
                    <footer className={styles.footer}>
                        <div className={styles.logo}>
                            <Link to="/">
                                <img src={lightMode ? "https://github.com/hsiang2/attimo-pizzeria/blob/master/public/images/img_logo_footer.png?raw=true" : "https://github.com/hsiang2/attimo-pizzeria/blob/master/public/images/img_logo_footer_dark.png?raw=true"} alt="logo" className={styles.logoSize} />
                            </Link>
                        </div>
